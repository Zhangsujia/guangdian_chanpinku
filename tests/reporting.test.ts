...
test("daily report includes status, stale links and low commission alerts", () => {
  const report = buildProductReport([
    { id: "p1", name: "面膜", status: "暂停推广", links: [{ platform: "抖音", commission: 25, status: "有效", updatedAt: "2026-08-10T12:00:00.000Z" }] },
    { id: "p2", name: "雨伞", status: "已下架", links: [{ platform: "视频号", commission: 35, status: "待复核", updatedAt: "2026-08-24T08:00:00.000Z" }] },
